data_cf=c(0.546, 0.172)
data_d=c(0.538, 0.212)
data_oc=c(0.469, 0.376)
data_l2s=c(0.867, 0.093)
data_ado=c(0.093, 0.033)
data_blt=c(0.111, 0.044)
data_occ=c(0.053, 0.376)
...
x <- barplot(data,
    main="Simple TOP 10 (with context initialization)", ylab="Time, ms",
