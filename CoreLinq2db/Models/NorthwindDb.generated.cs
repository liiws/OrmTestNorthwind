...
namespace DataModels
{
	...
	public static partial class NorthwindDBStoredProcedures
	{
		...
		public static IEnumerable<CustOrderHistResult> CustOrderHist(this NorthwindDB dataConnection, string @CustomerID)
		{
		...
		public static IEnumerable<CustOrdersDetailResult> CustOrdersDetail(this NorthwindDB dataConnection, int? @OrderID)
		{
		...
		public static IEnumerable<CustOrdersOrdersResult> CustOrdersOrders(this NorthwindDB dataConnection, string @CustomerID)
		{
		...
		public static IEnumerable<EmployeeSalesByCountryResult> EmployeeSalesByCountry(this NorthwindDB dataConnection, DateTime? @Beginning_Date, DateTime? @Ending_Date)
		{
		...
		public static IEnumerable<SalesByYearResult> SalesByYear(this NorthwindDB dataConnection, DateTime? @Beginning_Date, DateTime? @Ending_Date)
		{
		...
		public static IEnumerable<SalesByCategoryResult> SalesByCategory(this NorthwindDB dataConnection, string @CategoryName, string @OrdYear)
		{
		...
		public static int SpAlterdiagram(this NorthwindDB dataConnection, string @diagramname, int? @owner_id, int? @version, byte[] @definition)
		{
		...
		public static int SpCreatediagram(this NorthwindDB dataConnection, string @diagramname, int? @owner_id, int? @version, byte[] @definition)
		{
		...
		public static int SpDropdiagram(this NorthwindDB dataConnection, string @diagramname, int? @owner_id)
		{
		...
		public static IEnumerable<SpHelpdiagramdefinitionResult> SpHelpdiagramdefinition(this NorthwindDB dataConnection, string @diagramname, int? @owner_id)
		{
		...
		public static IEnumerable<SpHelpdiagramsResult> SpHelpdiagrams(this NorthwindDB dataConnection, string @diagramname, int? @owner_id)
		{
		...
		public static int SpRenamediagram(this NorthwindDB dataConnection, string @diagramname, int? @owner_id, string @new_diagramname)
		{
		...
		public static IEnumerable<TenMostExpensiveProductsResult> TenMostExpensiveProducts(this NorthwindDB dataConnection)
		{
